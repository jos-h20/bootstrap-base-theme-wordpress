...
function bootstrapwp_setup() {
	...
	// Support for Wordpress 4.+ to display titles
...
function bootstrapwp_scripts() {
	...
	wp_enqueue_style( 'animate-styles', get_template_directory_uri() . '/css/animate-custom.css', array(), '1.0.0', 'all' );
	...
	wp_enqueue_script( 'main-js', get_template_directory_uri() . '/js/main.js', array('jquery'), '3.3.7', true );
