     ...
     */
     ...
     Redux::setSection( $opt_name, array(
                    ...
                    'fields'    => array(
                        ...
                        array(
                            'title'     => __( 'Logo Text', 'bootstrapwp' ),
                            'subtitle'  => __( 'Display custom logo text', 'bootstrapwp' ),
                            'id'        => 'logo-text',
     ...
     //Homepage
       Redux::setSection( $opt_name, array(
           ...
           'fields'    => array(
               ...
               array(
                 'title'     => __( 'Hero Banner Content', 'bootstrapwp' ),
                 'subtitle'  => __( 'This is the text that will replace the banner content.', 'bootstrapwp' ),
                 'id'        => 'hero-banner-content',
                 'default'   => '<h1><i class="fa fa-diamond"></i></h1>
                 	  		 		     <p>A Bootstrap 3 HTML/CSS Theme.</p>
                 	  		 		     <p>Exclusive for BootstrapWP-Portfolio.</p>',
                 'type'      => 'textarea',
               ),
               array(
                 'title'     => __( 'Hero Banner Image', 'bootstrapwp' ),
               ...
               array(
                 'title'     => __( 'Services Posts Per Page', 'bootstrapwp' ),
                 'subtitle'  => __( 'Select the number of services you want to post', 'bootstrapwp' ),
                 'id'        => 'service-posts-per-page',
                 'default'   => 3,
                 'type'      => 'text',
               ),
               array(
                 'title'     => __( 'Two Column Title', 'bootstrapwp' ),
                 'subtitle'  => __( 'Title text for two column module.', 'bootstrapwp' ),
                 'id'        => 'tc-title',
                 'default'   => 'A LITTLE ABOUT OUR AGENCY',
                 'type'      => 'text',
               ),
               array(
                 'title'     => __( 'Two Column - Left', 'bootstrapwp' ),
                 'subtitle'  => __( 'Title text for the left column.', 'bootstrapwp' ),
                 'id'        => 'tc-left',
                 'default'   =>
               ...
               array(
                 'title'     => __( 'Two Column - Right', 'bootstrapwp' ),
                 'subtitle'  => __( 'Title text for the right column.', 'bootstrapwp' ),
                 'id'        => 'tc-right',
                 'default'   =>
               ...
               array(
                 'title'     => __( 'Divider 1 Content', 'bootstrapwp' ),
                 'subtitle'  => __( 'Text for divider 1.', 'bootstrapwp' ),
                 'id'        => 'd1-content',
                 'default'   => '<h1>DESIGN SOLVE PROBLEMS</h1>
                                <hr><p>From the purely practical to the richly philosophical, design is the solution to a host of challenges.</p>',
                 'type'      => 'textarea',
               ),
               array(
                 'title'     => __( 'Divider 1 Image', 'bootstrapwp' ),
                 'subtitle'  => __( 'This is the divider 1 image.', 'bootstrapwp' ),
                 'id'        => 'd1-img',
                 'type'      => 'media',
                 'url'      => true,
               ),
               array(
                 'title'     => __( 'Portfolio Posts Per Page', 'bootstrapwp' ),
                 'subtitle'  => __( 'Select the number of portfolio pieces you want to post', 'bootstrapwp' ),
                 'id'        => 'portfolio-posts-per-page',
                 'default'   => 6,
                 'type'      => 'text',
               ),
               array(
                 'title'     => __( 'Portfolio Title', 'bootstrapwp' ),
                 'subtitle'  => __( 'Title text for portfolio module.', 'bootstrapwp' ),
                 'id'        => 'portfolio-title',
                 'default'   => 'WE CREATE COOL STUFF',
                 'type'      => 'text',
               ),
               array(
                 'title'     => __( 'Divider 2 Content', 'bootstrapwp' ),
                 'subtitle'  => __( 'Text for divider 2.', 'bootstrapwp' ),
                 'id'        => 'd2-content',
               ...
               array(
                 'title'     => __( 'Divider 2 Image', 'bootstrapwp' ),
                 'subtitle'  => __( 'This is the divider 2 image.', 'bootstrapwp' ),
                 'id'        => 'd2-img',
                 'type'      => 'media',
                 'url'      => true,
               ),
       ...
       Redux::setSection( $opt_name, array(
         ...
         Redux::setSection( $opt_name, array(
           ...
           'fields'    => array(
             ...
             array(
               'title'     => __( 'Service Content', 'bootstrapwp' ),
               'subtitle'  => __( 'This is the content about the services', 'bootstrapwp' ),
               'id'        => 'services-content',
               'default'   => '<h3 class="text-center">Services We Offer </h3>
               						<p class="text-center">Lorem ipsum dolor sit amet, consectetur adipiscing elit. Pellentesque aliquam mattis ex, ut imperdiet magna imperdiet at. Proin eget pulvinar lorem. Curabitur rhoncus vehicula libero, nec porttitor lectus. Fusce mattis eu leo id tempus. </p>',
               'type'      => 'editor',
           ...
           //Footer
             Redux::setSection( $opt_name, array(
                 ...
                 'fields'    => array(
                     array(
                         'title'     => __( 'Footer Title Text', 'bootstrapwp' ),
                         'subtitle'  => __( 'Add the text that will display above the footer widgets.', 'bootstrapwp' ),
                         'id'        => 'footer-title',
                     ...
                     array(
                         'title'     => __( 'Custom Copywright', 'bootstrapwp' ),
                         'subtitle'  => __( 'Add your own custom text/html for copywright region.', 'bootstrapwp' ),
                         'id'        => 'custom-copywright',
                         'default'   => '<h4>Created by <a href="http://braginteractive.com">Brad Williams</a> - &copy; Copywright 2016</h4>',
                         'type'      => 'textarea',
                     ),
                 ),
           )  );
